...
CPP = g++
CPPFLAGS = -g -O3 $(INCFLAGS)  -fopenmp -Wall -Wno-strict-aliasing -std=c++0x
LINKERFLAGS = -lz
...
all: apps tests 
pg: example_apps/pagerank example_apps/pagerank_orig
apps: example_apps/pagerank example_apps/pagerank_orig example_apps/pagerank_functional example_apps/connectedcomponents example_apps/communitydetection example_apps/unionfind_connectedcomps example_apps/stronglyconnectedcomponents example_apps/trianglecounting example_apps/randomwalks example_apps/minimumspanningforest
